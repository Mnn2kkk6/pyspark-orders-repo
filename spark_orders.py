...
def main() -> None:
    ...
    # ============================================================
    # BƯỚC 2: Tạo DataFrame đơn hàng thủ công, gồm 5 cột:
    ...
    # ============================================================
    # BƯỚC 8: Đọc file orders.csv bằng PySpark
    # ============================================================
    df_csv = (
        spark.read
        .option("header", True)
    ...
    # BƯỚC 9: Lặp lại select / filter / groupBy trên dữ liệu đọc từ CSV
    ...
    # ============================================================
    # BƯỚC 10: Ghi các bảng kết quả của Phần 2 ra CSV (mỗi bảng 1 file riêng)
    # ============================================================
    ...
    # ============================================================
    # BƯỚC 11: Tạo temp view từ DataFrame để truy vấn bằng SQL thuần
    # ============================================================
    df_csv.createOrReplaceTempView("orders")

    # BƯỚC 12: SQL - tổng amount theo province (tất cả trạng thái)
    ...
    # BƯỚC 13: SQL - tương đương filter SUCCESS + group by province
